    ...
    Query: {
        ...
        getThreadsByCategoryId: async (
            ...
            try {
                ...
                return {
                    messages: threads.messages ? threads.messages : ["An error occured"],
                };
            } catch (ex) {
                throw ex;
            }
    ...
    Mutation: {
        ...
        createThreadItem: async (
            ...
            try {
                ...
                return {
                    messages: result.messages ? result.messages : ["An error has occured."],
                };
            } catch (ex) {
                console.log(ex);
                throw ex;
        ...
        register: async (
            ...
            try {
                ...
                return user && user.messages ? user.messages[0] : "An error has occured";
            } catch (ex) {
                throw ex;
            }
        },
        ...
        changePassword: async (
            ...
            try {
                ...
                let result = await changePassword(ctx.req.session!.userId, args.newPassword);
